...
const (
	Calculate_Calculate_FullMethodName = "/calculate.Calculate/Calculate"
)
...
func (c *calculateClient) Calculate(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateReply, error) {
...
func (UnimplementedCalculateServer) Calculate(context.Context, *CalculateRequest) (*CalculateReply, error) {
